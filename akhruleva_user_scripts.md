...
2. Шести-цифирный "код подтверждения" генерируется в приложении и передается серверу, который формирует и отправляет электронное письмо на указанный адрес электронной почты
